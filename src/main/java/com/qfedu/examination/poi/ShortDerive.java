...
public class ShortDerive {
    public static void createExcel(List<ShortQuestion> shortList, String filePath, String fileName) throws IOException {
        //1、创建文档对象
        SXSSFWorkbook workbook = new SXSSFWorkbook();
        //2、创建Sheet
        SXSSFSheet sxssfSheet = workbook.createSheet("简答题");
        //3、创建标题行
        ...
        int i = 0;
        for (ShortQuestion choice : shortList) {
            ...
            c03.setCellValue(choice.getAnswer());
